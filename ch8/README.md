...
- Delta Tableアーカイブ機能を使用する場合はUnity Catalogへのアクセス権限
...
- Delta Tableアーカイブ(セクション4.2)を使用する場合は、Unity Catalogのカタログ・スキーマ名を環境に合わせて変更してください
- 料金は2025年12月時点の参考値です
